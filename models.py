...
class Follows(db.Model):
    ...
    #based on users.id to identify who is being followed/followers
...
class User(db.Model):
    ...
    #uses by User.following/followers and identify/shows who is following/follower by that == id. Which is the users.id
